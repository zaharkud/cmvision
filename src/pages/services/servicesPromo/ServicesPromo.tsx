...
const camSystems = () => {
  return (
    <div className={style.text}>
      ...
      <p>
        Система видеонаблюдения позволит отслеживать происходящее на охраняемом
        объекте в режиме реального времени, играя важную роль в обеспечении
        безопасности. К этому вопросу необходимо подходить предельно серьезно.
        Настройка камер и монтаж камер видеонаблюдения лучше доверить опытным
        специалистам.
      </p>
    </div>
  );
...
const securitySystems = () => {
  return (
    <div className={style.text}>
      ...
      <p>
        Безусловно, можно установить только систему видеонаблюдения и стараться
        постоянно контролировать ситуацию на объекте. Но лучшим вариантом
        является тандем охранной системы и видеонаблюдения в доме, в офисе, на
        складе или в магазине. Это позволит не только разобраться в деталях уже
        произошедшего, но и предотвращать неприятные случаи.
      </p>
    </div>
  );
};
  ...
  return (
    <div className={style.text}>
      <p>
        ...
        прочих объектов не обходятся без системы контроля и управления доступом
        (СКУД).
      </p>
      <p>
        ...
        пропускной системы, оперативное блокирование или разблокирование дверей,
        идентификация личности и прочие.
      </p>
    </div>
  );
};
